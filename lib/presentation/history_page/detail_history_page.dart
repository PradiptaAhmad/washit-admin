...
import 'package:washit_admin/presentation/history_page/widget/history_status_progress_widget.dart';
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return RefreshIndicator(
          onRefresh: () async {
            await controller.getDetailHistory();
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                    ...
                    childs: Padding(
                        ...
                        child: Column(children: [
                          ...
                          DetailDataWidget(
                              ...
                              rightTitle: controller.detailData['jenis_pemesanan'] ==
                                  'antar_mandiri'
                                  ? "Antar mandiri"
                                  : "Antar Jemput"),
                          SizedBox(height: 5),
                          DetailDataWidget(
                              ...
                              rightTitle: "${controller.detailData['laundry_service']}"),
                          SizedBox(height: 5),
                          DetailDataWidget(
                              leftTitle: "Berat laundry",
                              rightTitle: controller.detailData['berat_laundry'] == null
                ...
                Visibility(
                    visible: controller.detailData['jenis_pemesanan'] == 'antar_mandiri'
                        ? false
                        : true,
                    child: Column(children: [
                      SizedBox(height: 10),
                      ...
                      childs: Padding(
                          ...
                          child: Column(children: [
                            ...
                            DetailDataWidget(
                                ...
                                rightTitle: controller.detailData['metode_pembayaran'] ==
                                    "tunai"
                                    ? "Tunai"
                                    : "Non Tunai"),
                            SizedBox(height: 5),
